...
# source: https://github.com/lateral/hs-semantic-tree/blob/master/gmm_tree.py
...
def cluster_next_node(t, node, node_codes, verbose=0):
    ...
    if len(node.vecs) < 2:
        ...
        gmm = GMM(n_components=2, covariance_type='spherical', verbose=0, max_iter=100)
...
def gmm_clustering(df_vals, save_file, verbose=0):
    """
